...
class ActionChoiceWidget(QWidget):
    ...
    def __init__(self, parent: Optional[QWidget] = None):
        ...
        self.melee_button = QPushButton(format_action_display("Melee Action"))
        ...
        self.missile_button = QPushButton(format_action_display("Missile Action"))
        ...
        self.magic_button = QPushButton(format_action_display("Magic Action"))
        ...
        self.skip_button.setStyleSheet("QPushButton { background-color: #868e96; color: white; font-weight: bold; }")
    ...
    def set_available_actions(self, acting_army: Dict[str, Any], terrain_data: Optional[Dict[str, Any]] = None):
        ...
        if terrain_data and location in terrain_data:
            ...
            self.terrain_info_label.setText(f"Terrain Die Face: {terrain_die_face} (Unknown terrain)")
