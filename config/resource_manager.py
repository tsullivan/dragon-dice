...
class ResourceManager:
    ...
    def load_unit_definitions(self) -> Dict[str, List[Dict]]:
        ...
        try:
            ...
            print(f"ERROR: Unit definitions file not found at {self.paths.unit_definitions_file}")
            return {}
        except json.JSONDecodeError as e:
            print(f"ERROR: Invalid JSON in unit definitions file: {e}")
            return {}
        ...
        try:
            ...
            for category, names in names_by_category.items():
                if not names:
                    ...
                    # Add default names
                    if category == "Player":
                        names_by_category[category] = ["Player 1", "Player 2", "Player 3", "Player 4"]
                    elif category == "Army":
                        names_by_category[category] = ["Army 1", "Army 2", "Army 3", "Army 4"]
