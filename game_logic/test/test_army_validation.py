...
class TestArmyComposition(unittest.TestCase):
    ...
    def test_get_total_points_with_dict_units(self):
        ...
        army = ArmyComposition(
            army_type="Campaign",
            units=[self.dict_unit_1pt, self.dict_unit_2pt]
        )
    ...
    def test_get_unit_count(self):
        ...
        army = ArmyComposition(
            army_type="Home",
            units=[self.mock_unit_1pt, self.mock_unit_2pt]
        )
...
class TestDragonDiceArmyValidator(unittest.TestCase):
    ...
    def test_rule_3_magic_units_exceed_50_percent_fails(self):
        ...
        armies = [
            ...
            ArmyComposition("Campaign", [self.magic_unit_2pt, self.unit_2pt, self.unit_2pt])  # 2 pts magic + 4 pts non-magic = 6 pts total
        ]
    ...
    def test_rule_4_total_points_not_equal_force_size_fails(self):
        ...
        self.assertFalse(result.is_valid)
        self.assertTrue(any("Total army points (3 pts) must equal selected force size (10 pts)" in error for error in result.errors))
    ...
    def test_from_player_data(self):
        ...
        player_data = {
            "armies": {
                ...
                "campaign": {
                    "units": [{"max_health": 3, "unit_type": "unit3"}]
                }
            }
        }
