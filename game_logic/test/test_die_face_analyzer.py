...
class TestDieFaceCount(unittest.TestCase):
    ...
    def test_creation_with_icon(self):
        ...
        face_count = DieFaceCount(
            face_type=constants.ICON_MELEE,
            count=3,
            icon="⚔️"
        )
    ...
    def test_creation_with_auto_icon(self):
        ...
        face_count = DieFaceCount(
            face_type=constants.ICON_MISSILE,
            count=2
        )
...
class TestDieFaceAnalyzer(unittest.TestCase):
    ...
    def test_get_face_distribution_summary(self):
        ...
        self.assertEqual(summary["percentages"][constants.ICON_MELEE], expected_melee_percentage)
    ...
    def test_compare_army_compositions(self):
        ...
        # Check differences
        self.assertEqual(comparison["face_differences"][constants.ICON_MELEE]["difference"], 3)  # Army1 has 3 more melee
        self.assertEqual(comparison["face_differences"][constants.ICON_MISSILE]["difference"], -4)  # Army1 has 4 fewer missile
        self.assertEqual(comparison["face_differences"][constants.ICON_SAVE]["difference"], 0)  # Equal saves
    ...
    def test_get_icon_for_face_type(self):
        ...
        self.assertEqual(DieFaceAnalyzer.get_icon_for_face_type(constants.ICON_MELEE), "⚔️")
        self.assertEqual(DieFaceAnalyzer.get_icon_for_face_type(constants.ICON_MISSILE), "🏹")
        self.assertEqual(DieFaceAnalyzer.get_icon_for_face_type(constants.ICON_SAVE), "🛡️")
