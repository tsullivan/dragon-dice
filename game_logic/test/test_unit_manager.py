...
class TestUnitSorter(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_units = [
            ...
            {"display_name": "Cutthroat", "max_health": 2, "unit_class_type": "Heavy Melee"},
            {"display_name": "Berserker", "max_health": 3, "unit_class_type": "Heavy Melee"}
        ]
    ...
    def test_sort_units_custom(self):
        ...
        sorted_units = UnitSorter.sort_units_custom(
            self.test_units, 
            lambda unit: -len(unit["display_name"])
        )
...
class TestUnitOrganizer(unittest.TestCase):
    ...
    def setUp(self):
        """Set up test fixtures."""
        self.test_units = [
            {"unit_type_id": "goblin_thug", "display_name": "Thug", "unit_class_type": "Heavy Melee", "max_health": 1},
            {"unit_type_id": "goblin_archer", "display_name": "Archer", "unit_class_type": "Missile", "max_health": 2},
            {"unit_type_id": "feral_lynx", "display_name": "Lynx", "unit_class_type": "Heavy Melee", "max_health": 1},
            {"unit_type_id": "orc_wizard", "display_name": "Wizard", "unit_class_type": "Magic", "max_health": 3},
            {"unit_type_id": "goblin_berserker", "display_name": "Berserker", "unit_class_type": "Heavy Melee", "max_health": 4}
        ]
