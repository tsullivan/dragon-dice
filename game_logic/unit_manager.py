...
class UnitOrganizer:
    ...
    @staticmethod
    def group_by_class_type(units: List[Dict[str, Any]]) -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    @staticmethod
    def group_by_cost_range(units: List[Dict[str, Any]], ranges: List[Tuple[int, int]] = None) -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    def filter_units(units: List[Dict[str, Any]], filters: Dict[str, Any]) -> List[Dict[str, Any]]:
        ...
        for field, value in filters.items():
            ...
            if isinstance(value, str):
                ...
                filtered_units = [
                    unit for unit in filtered_units 
                    if unit.get(field) in value
                ]
            elif callable(value):
                # Custom filter function
                filtered_units = [
                    unit for unit in filtered_units 
                    if value(unit.get(field))
                ]
...
class UnitInstanceManager:
    ...
    def create_unit_instance(self, config: UnitInstanceConfig, existing_units: List[Any] = None) -> Optional[Any]:
        """
...
class UnitCollectionManager:
    ...
    def organize_units_for_display(self, units: List[Dict[str, Any]], organization: str = "species") -> Dict[str, List[Dict[str, Any]]]:
        """
    ...
    def search_units(self, units: List[Dict[str, Any]], search_term: str, search_fields: List[str] = None) -> List[Dict[str, Any]]:
        """
