    ...
    UnitModel(
        ...
        faces=[
            ...
            },
            {
                ...
                "description": "During a save roll against a melee attack, Counter generates four save results and inflicts four damage upon the attacking army. Only save results generated by spells may reduce this damage. Note: this damage is generated immediately, and is seperate from Scorching touch damage. When at a terrain that contains red (fire), Scalders making a save roll against a melee action inflict four points of damage on the attacking army. Only save results generated by spells may reduce this damage. Scorching Touch does not apply when saving against a counter-attack. During any other save roll, Counter generates four save results. During a melee attack, Counter generates four melee results. During a dragon attack, Counter generates four save and four melee results.",
            },
            {
                "name": "Move",
                "description": "Counts as two movement points.",
    ...
    UnitModel(
        ...
        faces=[
            ...
            },
            {
                ...
                "description": "During any roll, Fly generates four maneuver or four save results. * When at a terrain that contains red (fire), Scalders making a save roll against a melee action inflict four points of damage on the attacking army.",
            },
            {
                "name": "Scorching Shield",
                "description": "Counts as two save points.  When at a terrain that contains red (fire), Scalders making a save roll against a melee action inflict two points of damage on the attacking army.",
