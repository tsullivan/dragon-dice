...
from models.test.mock.typed_models import create_test_unit, create_test_army
...
class TestTypedGameEngineFlows:
    ...
    def test_typed_error_detection(self):
        ...
        try:
            invalid_unit = create_test_unit(
                unit_id="invalid_unit",
                name="Invalid Unit",
                unit_type="test_type",
                species_key="INVALID_SPECIES"  # This should fail
            )
            assert False, "Should have caught invalid species"
        ...
        try:
            ...
            assert False, "Should have caught incomplete army data"
