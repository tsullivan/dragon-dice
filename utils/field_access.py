...
def strict_get_optional(data: Dict[str, Any], field_name: str, default: Optional[T] = None) -> Union[Any, T]:
    """
...
def strict_get_with_fallback(
    data: Dict[str, Any], field_name: str, fallback_field: str, model_name: str = "model"
) -> Any:
    """
