...
class DistanceRollsView(QWidget):
    ...
    def __init__(self, player_setup_data, frontier_terrain, first_player_name=None, parent=None):
        ...
        for _i, p_data in enumerate(self.player_setup_data):
            ...
            if player_name == self.first_player_name:
                ...
                frontier_terrain_label.setStyleSheet("font-weight: bold; color: #006600;")
    ...
    def _on_submit_rolls(self):
        ...
        for input_key, button_group in self.roll_inputs.items():
            ...
            if checked_button is None:
                ...
                self.status_label.setText(f"Error: No roll value selected for {player_name}'s {terrain_type} terrain.")
                all_valid = False
                break
    ...
    def _set_distance_rolls_help_text(self):
        self.tabbed_widget.set_help_text(self.help_model.get_distance_rolls_help(self.frontier_terrain))
